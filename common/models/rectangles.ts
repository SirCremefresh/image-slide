...
import {PercentageSize, Size, ZPercentageSize, ZSize} from "@common/models/sizes.ts";
import z from "zod";
...
assertType<TypeEqualityGuard<ViewportRectangle, z.infer<typeof ZViewportRectangle>>>()
