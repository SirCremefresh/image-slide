                        ...
                        <div className="mt-2 text-center sm:ml-4 sm:text-left">
                            ...
                            <div className="flex w-full items-center justify-center">
                                <label
                                    ...
                                    className="bg-center bg-no-repeat bg-contain flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100"
                                >
