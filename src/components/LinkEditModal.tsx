...
function ImageAutocomplete(props: {
    ...
    return (
        <Combobox as="div" value={props.selectedImage} onChange={props.setSelectedImage}>
                        ...
                        {filteredImages.map((person) => (
                            ...
                            >
                                {({active, selected}) => (
                                    <>
                                        <span
                                            className={classNames('block truncate', selected && 'font-semibold')}>{person.title}</span>
                ...
                <div className="flex min-h-screen items-center px-4 py-8">
                    <div className="relative mx-auto w-full max-w-lg rounded-md bg-white p-4 shadow-lg">
                        <div className="mt-2 text-center sm:ml-4 sm:text-left">
                            ...
                            <ImageAutocomplete selectedImage={selectedImage} setSelectedImage={setSelectedImage}
